...
const MESSAGES: Record<SupportedLocale, TranslationMessages> = {
    en: {
        ...
        'tooltip.optimizeTitle': 'Optimize the Codex max context size to save tokens and ease rate limits',
    ...
    ar: {
        ...
        'tooltip.optimizeTitle': 'تحسين الحجم الأقصى لسياق Codex لتوفير الرموز وتخفيف حدود معدل الاستخدام',
    ...
    de: {
        ...
        'tooltip.optimizeTitle': 'Die maximale Kontextgröße von Codex optimieren, um Tokens zu sparen und Ratenlimits zu entlasten',
    ...
    es: {
        ...
        'tooltip.optimizeTitle': 'Optimizar el tamaño máximo de contexto de Codex para ahorrar tokens y aliviar los límites de uso',
    ...
    fr: {
        ...
        'tooltip.optimizeTitle': 'Optimiser la taille maximale du contexte de Codex pour économiser des tokens et alléger les limites de débit',
    ...
    hi: {
        ...
        'tooltip.optimizeTitle': 'टोकन बचाने और दर सीमाओं को कम करने के लिए Codex के अधिकतम संदर्भ आकार को अनुकूलित करें',
    ...
    id: {
        ...
        'tooltip.optimizeTitle': 'Optimalkan ukuran konteks maksimum Codex untuk menghemat token dan meringankan batas laju',
        'tooltip.output': 'Output',
    ...
    it: {
        ...
        'tooltip.optimizeTitle': 'Ottimizza la dimensione massima del contesto di Codex per risparmiare token e alleggerire i limiti di frequenza',
        'tooltip.output': 'Output',
        'tooltip.period': 'Periodo',
        'tooltip.rate': 'Tasso',
    ...
    ja: {
        ...
        'tooltip.optimizeTitle': 'トークンを節約しレート制限を緩和するため、Codex の最大コンテキストサイズを最適化します',
        'tooltip.output': '出力',
        'tooltip.period': '期間',
        'tooltip.rate': '率',
    ...
    ko: {
        ...
        'tooltip.optimizeTitle': '토큰을 절약하고 사용률 제한을 완화하기 위해 Codex의 최대 컨텍스트 크기를 최적화합니다',
        'tooltip.output': '출력',
        'tooltip.period': '기간',
        'tooltip.rate': '비율',
    ...
    'pt-br': {
        ...
        'tooltip.optimizeTitle': 'Otimizar o tamanho máximo de contexto do Codex para economizar tokens e aliviar os limites de taxa',
    ...
    ru: {
        ...
        'tooltip.optimizeTitle': 'Оптимизировать максимальный размер контекста Codex, чтобы экономить токены и снизить нагрузку на лимиты скорости',
    ...
    tr: {
        ...
        'tooltip.optimizeTitle': 'Token tasarrufu yapmak ve hız sınırlarını hafifletmek için Codex maksimum bağlam boyutunu optimize edin',
    ...
    vi: {
        ...
        'tooltip.optimizeTitle': 'Tối ưu hóa kích thước ngữ cảnh tối đa của Codex để tiết kiệm token và giảm bớt giới hạn tốc độ',
    ...
    'zh-cn': {
        ...
        'tooltip.optimize': '优化',
        'tooltip.optimizeTitle': '优化 Codex 的最大上下文大小，以节省 token 并缓解速率限制',
        'tooltip.output': '输出',
        'tooltip.period': '周期',
        'tooltip.rate': '比率',
    ...
    'zh-tw': {
        ...
        'tooltip.optimizeTitle': '最佳化 Codex 的最大內容大小，以節省 token 並緩解速率限制',
        'tooltip.output': '輸出',
        'tooltip.period': '期間',
        'tooltip.rate': '比率',
