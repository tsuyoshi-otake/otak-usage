...
- otak-usage now detects fast mode for both providers and warns with the same notification the cost and limit alerts use — **Open Settings** and **Not Today** buttons included, so one click silences it for the rest of the day.
